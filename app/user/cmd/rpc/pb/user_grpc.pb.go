...
func (c *userClient) Create(ctx context.Context, in *CreateReq, opts ...grpc.CallOption) (*CreateReply, error) {
	out := new(CreateReply)
...
func (UnimplementedUserServer) Create(context.Context, *CreateReq) (*CreateReply, error) {
